...
# CUDA 11.8) and installs every metric dependency: insightface
# (buffalo_l = RetinaFace + ArcFace), decord, imageio[ffmpeg], scipy.
#
...
# =============================================================================
# Step 3: pre-warm InsightFace's buffalo_l pack (~330 MB)
# =============================================================================
