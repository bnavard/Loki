...
`outputs/marionette_eval/hdtf/<protocol>/run_<ts>/samples/<sample_id>/`,
...
**Prerequisite — HDTF FLAME tracking.** The Marionette inference path
...
```
outputs/marionette_eval/hdtf/<protocol>/run_<timestamp>/
