...
Usage:
    ...
    PYTHONPATH=. python text_to_expr_field/scripts/generate_captions.py --asr_only

    # Single clip test:
    PYTHONPATH=. python text_to_expr_field/scripts/generate_captions.py --test --clip abc123

    # Parallel across GPUs:
    PYTHONPATH=. python text_to_expr_field/scripts/generate_captions.py --gpu 0 --num_gpus 8
"""
