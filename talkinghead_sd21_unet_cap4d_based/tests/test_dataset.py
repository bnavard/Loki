...
def make_bg_plate_vis(ds_bg, idx):
    ...
    from talkinghead_sd21_unet_cap4d_based.utils.background import crop_background_plate, load_fg_mask
    from talkinghead_sd21_unet_cap4d_based.data.utils import get_bbox_from_verts
    ...
    for fid in frame_ids:
        ...
        from talkinghead_sd21_unet_cap4d_based.utils.background import composite_frame_with_background
