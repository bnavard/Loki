...
class TestAudioEncoder:
    def test_output_shape(self):
        ...
        """
        from marionette.model.audio_encoder import AudioEncoder
...
class TestTHUnetModel:
    def _build_unet(self):
        from marionette.model.th_unet import THUnetModel
        return THUnetModel(
...
class TestTHDiffusion:
    def _build_model(self):
        ...
        from marionette.conditioning.th_conditioning import THConditioning
        from marionette.model.audio_encoder import AudioEncoder
        from marionette.model.th_diffusion import THDiffusion
