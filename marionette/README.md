...
output dict in `MarionetteDiffusion.get_input` — the conditioning module
...
├── model/
│   ├── diffusion.py               # MarionetteDiffusion — LDM + CFG + sample_video DDIM
│   ├── unet.py                    # MarionetteUNet — SD 2.1 UNet + 3D attention + audio x-attn + ref-K/V injection
